...
class Slider extends React.Component {
    constructor(props){
        ...
        this.state.max = this.state.slides.length; //зависимость. 
        this.intervalBetweenSlides = this.intervalBetweenSlides.bind(this); //контекст вызова.
    ...
    componentDidMount(){
        this.interval = setInterval(()=> this.intervalBetweenSlides(), 3000 )// тут 300 милисекунд
    }
